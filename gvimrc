...
" Maximimize the gVim window for 3440x1440 / 35" monitor:
autocmd Syntax * if &filetype !=# 'gitcommit' && &filetype !=# 'gitrebase' | set lines=61 columns=342 | endif
autocmd Syntax * if &filetype ==# 'gitcommit' || &filetype ==# 'gitrebase' | set lines=61 columns=120 | endif
